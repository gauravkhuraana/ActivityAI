...
flowchart TD
    ...
    PS --> E2E([Playwright E2E - 34 tests])
    BS --> API([Jest + Supertest - 27 tests])
    DS --> BDD([Cucumber BDD - 25 scenarios])
    E2E & API & BDD --> CI([GitHub Actions - Phase 1 to Phase 2 to Phase 3])
